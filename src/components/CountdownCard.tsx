...
const CountdownCard = ({ event, onRemove, onEdit }: CountdownCardProps) => {
  ...
  return (
    <div className="glass-card rounded-2xl p-7 animate-slide-up relative group">
      ...
      {expired ? (
        ...
        <div className="grid grid-cols-4 gap-6 text-center">
          {[
            ...
            <div key={item.label}>
              <div className="text-3xl font-extrabold text-primary tabular-nums">{item.value}</div>
