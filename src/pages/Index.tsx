...
const Index = () => {
  ...
  return (
    <div
      className={cn('min-h-screen bg-background flex', isLeftNav ? 'flex-row' : 'flex-col', 'max-w-4xl mx-auto')}
      data-school-bg={(settings as any).design_style === 'school' ? ((settings as any).school_background || 'gradient') : undefined}
    >
      {/* Left sidebar nav */}
      {isLeftNav && (
