...
export type TabType = 'inicio' | 'deberes' | 'examenes' | 'eventos' | 'partidos' | 'tareas' | 'horario' | 'no-olvidar' | 'notas' | 'productividad' | 'premios' | 'calendario' | 'papelera';
...
export const ALL_SPORT_TYPES = ['Fútbol', 'Baloncesto', 'Voleibol', 'Golf', 'Ping-Pong', 'Pádel', 'Tenis', 'Natación', 'Hípica'];
...
export const CUSTOM_SPORT_EMOJI = '🏅';
